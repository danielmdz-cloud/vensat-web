 ...
 */
import type { Field, FieldExtension, FieldGroupItem, DocumentPreview, DocumentFieldPreview, PreviewFields, ClientField } from './model-fields';
...
import { CustomActionClientModel, CustomActionDocument, CustomActionModel, CustomActionModelObject, CustomActionObjectModel } from './custom-actions';
export type Model<ModelContext = unknown> = ObjectModel<ModelContext> | DataModel<ModelContext> | PageModel<ModelContext> | ConfigModel<ModelContext>;
export type ModelWithSource<ModelType extends Model = Model> = ModelType & {
    srcType: string;
    srcProjectId: string;
};
...
export type DistributeModelExtensions<Type extends Model> = Type extends Model ? Partial<Omit<Type, 'name' | 'fields'>> & {
    name: string;
...
/** @deprecated */
export type ConfigClientModel = Omit<ConfigModel, 'context' | 'preview' | 'actions' | 'locale' | 'fields' | 'permissions'> & {
    preview?: PreviewFields;
    actions?: CustomActionClientModel<CustomActionObjectModel | CustomActionModelObject>[];
    fields: ClientField[];
    permissions?: ModelPermissions;
...
export type PageClientModel = Omit<PageModel, 'context' | 'preview' | 'actions' | 'filePath' | 'locale' | 'fields' | 'permissions'> & {
    preview?: PreviewFields;
...
export type DataClientModel = Omit<DataModel, 'context' | 'preview' | 'actions' | 'locale' | 'fields' | 'permissions'> & {
    preview?: PreviewFields;
    actions?: CustomActionClientModel<CustomActionDocument | CustomActionModel>[];
    fields: ClientField[];
    permissions?: ModelPermissions;
