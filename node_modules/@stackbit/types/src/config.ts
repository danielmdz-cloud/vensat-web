...
export interface StackbitConfig {
     ...
     */
    transformSitemap?: (options: ConfigDelegate & { sitemap: SiteMapEntry[]; userContext: User }) => SiteMapEntry[];
     ...
     */
    transformTreeViews?: (options: ConfigDelegate & { treeViews: TreeViewNode[]; userContext: User }) => TreeViewNode[];
     ...
     */
    filterAsset?: (options: ConfigDelegate & { asset: AssetWithSource; userContext: User }) => boolean | undefined;
